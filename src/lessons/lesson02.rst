...
Watch all of the videos in the **Lesson 2 Prep** assignment in Canvas.

In-class Work
-------------

Here is the `presentation <https://github.com/LaunchCoderGirlSTL/SQL-Materials/blob/master/Week%202/Normalization%20Steps.pdf/>`_ from class.
Download `database examples <https://github.com/LaunchCoderGirlSTL/SQL-Materials/blob/master/Week%202/DBDesignInClassExamples.xlsx/>`_ and do your work.
